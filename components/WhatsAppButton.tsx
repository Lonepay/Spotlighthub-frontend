...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 lg:bottom-5 right-5 z-40 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-elevated hover:scale-105 active:scale-95 transition-transform"
    >
